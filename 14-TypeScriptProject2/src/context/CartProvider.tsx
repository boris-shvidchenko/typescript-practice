...
const reducer = (state: CartStateType, action: ReducerAction): CartStateType => {
    switch (action.type) {
        ...
        case REDUCER_ACTION_TYPE.QTY: {
            if (!action.payload) {
                throw new Error('action.payload is missing in QTY action.')
            }
...
const initiCardContextState: UseCartContextType = {
    dispatch: () => {},
...
export const CartContext = createContext<UseCartContextType>(initiCardContextState);
